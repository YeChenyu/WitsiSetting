...
public class MyCusListView extends ListView implements OnScrollListener {
	...
	private static final String OPEN_UP_REFRESH = "松开搜索...";
	private static final String FINDING_DEVICE = "正在搜索设备...";
	...
	private void changeHeadView() {
		...
		case DONE:// 开始或结束状态
			...
			txtHeadTip.setText(PULL_DOWN_REFRESH);
		...
		case REFRESHING:
			...
			txtHeadTip.setText(FINDING_DEVICE);
			break;
		}
	}
	...
	private class LessPaddingSetRunnable implements Runnable {
		...
		public void run() {
			...
			if (canRunning && (currentPadding > -headContentHeight)) {
				MyCusListView.this.postDelayed(this, 16);
			} else {
				stop();
			}
		}
