...
public class DateTimeSettings extends SettingsPreferenceFragment
	...
	private static final String TAG = DateTimeSettings.class.getSimpleName();
    ...
    public void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.date_time_preference);
    ...
    private void initUI() {
        ...
        FyLog.d(TAG, "autoTimeEnabled="+ autoTimeEnabled+ " autoTimeZoneEnabled="+ autoTimeZoneEnabled);
        ...
        mTimeZone = findPreference(KEY_TIME_ZONE);
        mDatePref = findPreference(KEY_DATE);
        mTime24Pref = findPreference(KEY_24_HOUR);
    ...
    */
    ...
    /* package */ static void setDate(int year, int month, int day)  {
        ...
        if (when / 1000 < Integer.MAX_VALUE) {
			FyLog.d(TAG, "SystemClock.setCurrentTimeMillis");
