...
import com.witsi.settings.wireless_location.WirelessAndLocationSettings;
...
public class WifiEnabler implements CompoundButton.OnCheckedChangeListener  {
    ...
    private CheckSwitchButton mSwitch;
    ...
    public WifiEnabler(Context context, CheckSwitchButton switch_) {
        mContext = context;
        mSwitch = switch_;
        mWifiManager = (WifiManager) context.getSystemService(Context.WIFI_SERVICE);
        //register the broatcast
    ...
    /**
     * register the broatcast of wifi state 
     */
    public void resume() {
    ...
    /**
     * unregister the broatcast of wifi state 
     */
    public void pause() {
    ...
    /**
     * 设置WIFI开关
     * @param switch_ wifi开关控件
     */
    public void setSwitch(CheckSwitchButton switch_) {
        if (mSwitch == switch_) return;
        //释放资源
        mSwitch.setOnCheckedChangeListener(null);
        mSwitch = switch_;
        mSwitch.setOnCheckedChangeListener(this);
        //setting the state of wifi switch
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        if (isChecked && !WirelessAndLocationSettings.isRadioAllowed(mContext, Settings.Global.RADIO_WIFI)) {
