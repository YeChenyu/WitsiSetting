...
public class PointerSpeedPreference extends SeekBarDialogPreference implements
    ...
    protected View onCreateDialogView() {
    	...
    	View mView = LayoutInflater.from(mContext).inflate(getDialogLayoutResource(), null);
    ...
    protected void showDialog(Bundle state) {
    	...
    	dialog.setTitle(R.string.pointer_speed);
        dialog.setView(view);
        dialog.setNegativeButton(R.string.dlg_cancel, null);
