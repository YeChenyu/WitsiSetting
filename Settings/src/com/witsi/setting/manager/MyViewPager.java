...
public class MyViewPager extends ViewPager
{
	...
	public MyViewPager(Context context, AttributeSet attrs)
	{
		...
		int effect = ta.getInt(R.styleable.MyViewPager_style, 0);
		...
		setFadeEnabled(ta.getBoolean(R.styleable.MyViewPager_fadeEnabled,
				false));
		setOutlineEnabled(ta.getBoolean(
				R.styleable.MyViewPager_outlineEnabled, false));
		setOutlineColor(ta.getColor(R.styleable.MyViewPager_outlineColor,
				Color.WHITE));
		switch (mEffect)
		{
		case Stack:
...
//		return Math.abs(positionOffset) < 0.0001;
		return Math.abs(positionOffset) < 1;
	}
