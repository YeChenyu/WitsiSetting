...
//    private static final String KEY_USER_DICTIONARY_SETTINGS = "key_user_dictionary_settings";
    private static final String KEY_SPELLCHECKERS_SETTINGS = "spellcheckers_settings";
    private static final String KEY_KEYBOARD_SETTINGS_CATEGORY = "keyboard_settings_category";
    private static final String KEY_HARD_KEYBOARD = "hard_keyboard";
    private static final String KEY_VOICE_CATEGORY = "voice_category";
    private static final String KEY_POINTER_SETTINGS_CATEGORY = "pointer_settings_category";
    private static final String KEY_MOUSE_ADVANCE_SETTINGS_CATEGORY = "mouse_advance_settings_category";
    private static final String KEY_GAME_CONTROLLER_SETTINGS_CATEGORY = "game_controller_settings_category";
...
//            new ArrayList<PreferenceScreen>();
    ...
    public void onCreate(Bundle icicle) {
        ...
        if(title != null)
        	title.setText(getString(R.string.system_settings_language_inputmethod));
        removePreference(KEY_POINTER_SETTINGS_CATEGORY);
    }

    private void updateInputMethodSelectorSummary(int value) {
        String[] inputMethodSelectorTitles = getResources().getStringArray(
                R.array.timezone_filters);
