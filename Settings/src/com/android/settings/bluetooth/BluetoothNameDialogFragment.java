...
public final class BluetoothNameDialogFragment extends DialogFragment implements TextWatcher {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mAlertDialog.setTitle(R.string.bluetooth_rename_device);
        mAlertDialog.setView(createDialogView(deviceName));
        mAlertDialog.setPositiveButton(R.string.bluetooth_rename_button,
        ...
        mAlertDialog.setNegativeButton(android.R.string.cancel, null);
