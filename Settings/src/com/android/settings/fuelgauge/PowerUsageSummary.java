 ...
 */
public class PowerUsageSummary extends SettingsPreferenceFragment implements Runnable {
    ...
    public void onCreate(Bundle icicle) {
        ...
        ((TextView)getActivity().findViewById(android.R.id.title)).setText(getString(R.string.system_setting_battery));
    }
