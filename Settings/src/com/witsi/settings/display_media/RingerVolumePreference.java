...
public class RingerVolumePreference extends VolumePreference {
    ...
    protected View onCreateDialogView() {
    	...
    	View view = LayoutInflater.from(getContext()).inflate(getDialogLayoutResource(), null);
    ...
    protected void showDialog(Bundle state) {
    	...
    	dialog.setTitle(R.string.sound_category_sound_title);
    	dialog.setView(view);
    	dialog.setNegativeButton(R.string.dlg_ok, new DialogInterface.OnClickListener() {
			@Override
