...
public class SettingsPreferenceFragment extends PreferenceFragment implements DialogCreatable {
    ...
    public void onCreate(Bundle icicle) {
        ...
        FyLog.d(TAG, "SettingsPreferenceFragment.onCreate()");
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        FyLog.d(TAG, "SettingsPreferenceFragment.onActivityCreated()");
    ...
    public void onDetach() {
    	FyLog.d(TAG, "SettingsPreferenceFragment.onDetach()");
        if (isRemoving()) {
