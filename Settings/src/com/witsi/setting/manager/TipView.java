...
import com.witsi.setting.manager.luncher.*;
...
public class TipView extends LinearLayout{
	...
	private String TAG = TipView.class.getSimpleName();
	...
	public TipView(Context context) {
		...
		deleteView.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View arg0) {
				...
				TipView.this.listener.onDelPess(arg0);
...
//		this.setBackgroundColor(R.color.block);
		setFocusable(false);
...
//		tv_lp.width = LayoutParams.WRAP_CONTENT;
		tv_lp.width = (int) (tip_lp.height*1.1);
		tv_lp.leftMargin = 3;
		tv_lp.rightMargin = 3;
...
//				listener.onLongPress(v);
	...
	private Animation panelScaleDown(int id, final View v){
		...
		anim_scale_down.setAnimationListener(new AnimationListener() {
			...
			public void onAnimationEnd(Animation arg0) {
				// TODO Auto-generated method stub
				TipView.this.listener.onShortClick(v);
			}
			@Override
			public void onAnimationRepeat(Animation arg0) {
				// TODO Auto-generated method stub
	...
	public void setEnabled(boolean enabled) {
		...
		fl_item_layout.setVisibility(View.INVISIBLE);
	...
	public void setBoundary(int boundary){
		...
		FyLog.e(TAG, "the margin is; " + margin);
		if(margin >= 2){
			margin = 1;
		}
...
//			FyLog.v("df", "the margin is; " + margin);
		...
		if(weight != 1)
			...
			LinearLayout.LayoutParams tv_lp =
					new LinearLayout.LayoutParams(400, 
					LayoutParams.WRAP_CONTENT);
			tv_lp.gravity = Gravity.CENTER;
...
//		setBackground(this, R.drawable.btn_check_label_background);
		ll_grid_item.setBackgroundColor(R.color.block_bac);
	}
//	/**
//     * 设置毛玻璃背景
//     * @param id 背景图片id
