...
import com.witsi.settings.MyPreferenceCategory;
...
public class StorageVolumePreferenceCategory extends MyPreferenceCategory {
...
//        addPreference(mItemAvailable);
        ...
        final boolean showDetails = false;//mVolume == null || mVolume.isPrimary();
        if (showDetails) {
            if (showUsers) {
